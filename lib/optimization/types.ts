...
export type PenaltyWeights = {
    ...
    wSkipNearby: number; // extra seconds for skipping nearby stops
    wClusterExit: number; // extra seconds for exiting a cluster
};
...
export const DEFAULT_CLUSTER_THRESHOLD_METERS = 120;